...
def build_step3_bate_volta_diario_state(data=None):
    payload = data or {}
    return {
...
def step3_trecho_duplica_retorno(trecho, retorno, sede_estado_id=None, sede_cidade_id=None):
